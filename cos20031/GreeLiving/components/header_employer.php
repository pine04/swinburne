...
<header class="main-header clearfix" role="header" id="header">
	...
	<nav id="menu" class="main-nav" role="navigation">
		<ul class="main-menu">
			<li><a href="/employer/home"><?=$content["home"] ?></a></li>
			<li><a href="/about"><?=$content["about"] ?></a></li>
			<li><a href="/contact"><?=$content["contact"] ?></a></li>
			<li><a href="/employer/post-job"><?=$content["postJob"] ?></a></li>
			<li><a href="/employer/profile"><?=$content["profile"] ?></a></li>
			<li>
				<a href=<?=$returnUrl ?>>
			...
			<li><a href="/applicant/home"><?=$content["toApplicant"] ?></a></li>
		</ul>
	</nav>

...
namespace ShapeDrawer
{
    public class Program
    {
        ...
        public static void Main()
        {
            ...
            string fileLocation = "C:\\Users\\gnut\\Desktop\\TestDrawing.txt";
            ...
            do
            {
                ...
                if (SplashKit.KeyTyped(KeyCode.SKey))
                {
                    try
                    {
                        myDrawing.Save(fileLocation);
                    } catch (Exception e)
                    {
                        Console.WriteLine("Error saving file: ${0}", e.Message);
                    }
                }

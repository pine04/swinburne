...
import au.edu.swin.sdmd.core1.DiceRollActivity
import au.edu.swin.sdmd.core1.R
...
class MainActivity2Test {
    ...
    @Rule
    @JvmField
    var mActivityScenarioRule = ActivityScenarioRule(DiceRollActivity::class.java)

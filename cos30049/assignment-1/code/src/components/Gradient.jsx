/*
    ...
    Description: The Gradient component represents a generic container that has
                been stylized to have a linear gradient background and border.
*/
...
export default function Gradient({ gradientDirection, className, children }) {
    return (
        <div className={`rounded-2xl relative 
                         ${gradientDirection === "r" 
                            ? 
                            "bg-gradient-to-r after:bg-gradient-to-r" 
                            : 
                            "bg-gradient-to-br after:bg-gradient-to-br"
                         } 

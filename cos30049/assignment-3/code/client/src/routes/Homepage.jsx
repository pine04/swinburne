...
export default function Homepage() {
    return (
        <div className="overflow-x-clip">
            ...
            {/* The hero section. */}
            <article className="max-w-6xl px-8 py-12 mx-auto md:grid md:grid-cols-[1fr,auto] md:gap-8 md:items-center">
                
                {/* The splash text, description, and COA buttons. */}
                <div className="h-fit flex flex-col gap-8">

                    <h1 className="font-display text-4xl text-center md:text-5xl md:text-left">
                        Drip out your virtual avatar with Dripple
                    </h1>

                    <p className="max-w-md mx-auto text-center md:mx-0 md:text-left">
            ...
            <article className="max-w-6xl px-8 py-12 mx-auto">
                ...
                <h2 className="text-center font-display text-4xl">Most popular</h2>

                <Link to="/marketplace" className="block w-fit mx-auto mt-4 mb-8 relative after:absolute after:w-full after:h-0.5 after:left-0 after:top-full after:bg-white after:scale-0 hover:after:scale-100 after:transition-transform after:origin-left">
                    Explore the full collection 
                    <FontAwesomeIcon icon={faArrowRight} className="ml-2"/>
                </Link>

                {/* The featured items. */}
                <div className="w-fit mx-auto grid gap-8 grid-cols-1 sm:grid-cols-2 lg:grid-cols-4">
                    {
                        mostPopular.map((props, index) =>
                            <Card key={index} className="max-w-64">
                                ...
                                {
                                    index === 1 &&
                                    <div className="w-96 h-96 rounded-full absolute left-0 top-1/2 -translate-x-1/2 -translate-y-1/2 -z-20 bg-pink blur-[192px]"></div>
                                }
                            </Card>
                        )
                    }
            ...
            <article className="max-w-6xl px-8 py-12 mx-auto relative">
                ...
                <div className="w-96 h-96 rounded-full absolute left-0 top-1/2 -translate-x-1/2 -translate-y-1/2 -z-10 bg-pink blur-[192px]"></div>
                <div className="w-96 h-96 rounded-full absolute left-full top-2/3 -translate-x-1/2 -translate-y-1/2 -z-10 bg-purple blur-[192px]"></div>

                <h2 className="text-center font-display text-4xl">Join our community</h2>
                
                {/* The rotated cards, description, and COA button. */}
                <div className="md:max-w-4xl md:mx-auto md:flex md:items-center md:justify-between">

                    {/* The rotated cards. */}
                    <div className="w-fit h-96 mx-auto mt-12 mb-24 relative md:w-72 md:ml-12 md:mb-12 md:flex-shrink-0">
                        ...
                        <div className="w-fit absolute left-8 top-0 rotate-12 translate-y-48 md:left-16 md:translate-y-32">
                            <Card className="w-48">
                    ...
                    <div className="max-w-md mx-auto md:mx-0">
                        ...
                        <LinkButton to="/signup" className="mx-auto md:mx-0">
                            Create account
                        </LinkButton>
                    </div>

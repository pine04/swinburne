...
define('TUTORIAL_SESSION', 'Saturday 3:00PM');
...
define('DB_ENDPOINT', 'photoalbumdb.c6w0siafkfbt.us-east-1.rds.amazonaws.com');
// [ACTION REQUIRED] username of your RDS instance 
define('DB_USERNAME', 'admin');
// [ACTION REQUIRED] password of your RDS instance
define('DB_PWD', 'photoadmin');
...
define('DB_PHOTO_S3REFERENCE_COL_NAME', 's3_photo');
?>
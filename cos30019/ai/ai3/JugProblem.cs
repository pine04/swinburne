...
namespace AI3 {
    public class JugProblem : Problem {
        private int _capacityA, _capacityB;

        public JugProblem(int capacityA, int capacityB, int goalAmount) : base(new JugState(0, 0), new List<State> { new JugState(-1, goalAmount), new JugState(goalAmount, -1) }) {
